function history = rpdmm_overlap_for_random(A,b,K,rho,J,groups,gsize,T,alpha,lambda)
...
x = 0.001*eye(total_group,1);
z = zeros(n,1);
y = zeros(total_group,1);
yhat = zeros(total_group,1);
%y = zeros(gsize*J,1);
